...
- This repository mirrors approved public Aurato assets. Do not modify the private upstream library as part of repository maintenance.
- Preserve category folders at the root and descriptive lowercase hyphenated filenames. Keep stable Aurato IDs and exact upstream object paths in catalog metadata, not public filenames. `cards/` is the explicit aspect-ratio exception.
