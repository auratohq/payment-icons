...
A versioned collection of **8,089 payment-related PNG assets** maintained by [Aurato](https://aurato.io):   
**2,073 primary icons** and **6,016 card images**, across **10 categories**. Find cards, payment methods, wallets, markets, payment service providers (PSPs), currencies, banks, regulators, operators, schemes, and systems.
